...
parser.add_argument('-Q', '--partfunc', const=0, help='Include to calculate partition functions. Add a temperature to calculate at.',nargs='?')
...
if args.partfunc == None:
   ...
   if TEMPERATURE == 0.0: #VERY DIRTY FIX FOR DEFAULT VALUE
      TEMPERATURE = 298.15
