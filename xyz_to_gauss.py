...
Stars can still be used, however.''', epilog='''For help contact
    ...
    parser.add_argument('infile', type=str, nargs='+', help='The file(s) to convert into .com files', metavar='.xyz file')
...
#Needs to be changed!
    ...
    if BSE:
        ...
        try:
            basis_mol = BasisSet.GenerateBasisSet('gaussian94', basis, namesmol, True)
        except RuntimeError:
